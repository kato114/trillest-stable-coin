...
//// TRANSFER TRILLEST
/* To fund the below account with 2m TRILLEST run the following tasks:
 ...
 */
const signerWithTRILLEST = signers[4](
  await trillest.balanceOf(signerWithTRILLEST.address)
).toString();
// transfer TRILLEST to vault
await trillest
  .connect(signerWithTRILLEST)
  .transfer(compensationClaims.address, ethers.utils.parseUnits("1696590", 18));
//// END TRANSFER TRILLEST
...
await sendProposal(startArgs, "Start TRILLEST claiming period");
...
const root = {
  hash: "0x304013b1a650e205f3210663cdea44d1af2785d275268276a299c663ee2e4615",
  depth: 10,
};
