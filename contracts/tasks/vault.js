...
async function yield(taskArguments, hre) {
  ...
  console.log("Vault value", trillestUnitsFormat(vaultValue));
  let supply = await trillest.totalSupply();
  console.log("TRILLEST supply", trillestUnitsFormat(supply));
  ...
  console.log("Vault value", trillestUnitsFormat(vaultValue));
  supply = await trillest.totalSupply();
  console.log("TRILLEST supply", trillestUnitsFormat(supply));
}
