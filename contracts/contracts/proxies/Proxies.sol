...
/**
 * @notice TRILLESTProxy delegates calls to an TRILLEST implementation
 */
contract TRILLESTProxy is InitializeGovernedUpgradeabilityProxy {

}

/**
 * @notice WrappedTRILLESTProxy delegates calls to a WrappedTRILLEST implementation
 */
contract WrappedTRILLESTProxy is InitializeGovernedUpgradeabilityProxy {
