...
contract Sanctum {
    ...
    address public trillestContract;
    ...
    function setTRILLESTAddress(address _trillestContract) public {
        trillestContract = _trillestContract;
    }
}
...
contract Reborner {
    ...
    function transfer() public {
        ...
        address trillest = sanctum.trillestContract();
        require(IERC20(trillest).transfer(address(1), 1e18), "transfer failed");
