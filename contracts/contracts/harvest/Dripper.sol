 ...
 * that, the TRILLEST vault does not need any changes, not even to know the address
 * of the dripper.
...
contract Dripper is Governable {
    ...
    address immutable vault; // TRILLEST vault
